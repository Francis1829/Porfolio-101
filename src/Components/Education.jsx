...
<div className="bg-white text-black mt-20 relative">
        ...
        <div className="w-full h-full z-30 lg:p-10 p-7 ">
          ...
          <div className=" flex lg:flex-row flex-col lg:justify-around justify-center font-[grotesk]">
            <ul className="flex flex-col list-disc m-1 ">
                <li className='text-2xl my-2'> Bachelor of Science in Computer Science</li>
                <div>Isabela State University - Cauayan Campus</div>
                <div>(2016 - 2019)</div>
            </ul>
            <div className='m-1'>
            <ul className=' list-disc '>
                <li className='text-2xl my-2'>On The Job Training</li>
                <div>College of Computing Studies, Information and Communication Technology</div>
                <div>(May-June 2018)</div>
            </ul>
            <ul className=' list-disc '>
                <li className='text-2xl my-2'>Hold Down Press Operator</li>
                <div>Universal Leaf Philippines Inc.</div>
                <div>(Jan 2021 – Feb 2022)</div>
            </ul>
            <ul className=' list-disc '>
                <li className='text-2xl my-2'>Virtual Assistant</li>
                <div>HustleVA</div>
                <div>(july 2023)</div>
            </ul>
            </div>
