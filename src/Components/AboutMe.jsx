      ...
      <div className="bg-white text-black relative">
        ...
        <div className="w-full h-full z-30 py-7 xl:p-10 lg:p-7 md:p-4 sm:p-2 ">
          ...
          <div className=" flex xl:flex-row flex-col xl:justify-around justify-center items-center ">
            <div className="flex flex-col items-center w-auto lg:w-[70%] xl:m-5 lg:m-4 md:m-3 m-2">
          ...
          <div className="ikmg w-auto flex flex-col justify-center items-center mb-7 mt-10 px-10">
              <div className="font-[grotesk] font-semibold ">
                <img src={Percent1} alt="precent" className="w-[450px]" />
              ...
              <div className="font-[grotesk] font-semibold mt-2 ">
                <img src={Percent2} alt="precent" className="w-[450px]" />
